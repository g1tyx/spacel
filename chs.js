...
var cnItems = {
    ...
    'Have': '拥有',
    'Gaia': '盖亚',
    'You are out of power cell': '您没能量了',
    'The pirate ship weapon does': '海盗船武器造成',
    'You repaired': '你修复了',
    'of the hull': '船体',
    'Your rank isn\'t high enough': '你的等级不够高',
    'oxide': '氧化物',
    'silicate': '硅酸盐',
    '': '',
    '': '',
...
var cnRegReplace = new Map([
    ...
    [/^(.+) EXP$/, '$1 经验'],
    [/^(.+) EP$/, '$1 EP'],
    [/^(.+) are required to travel !$/, '旅行需要消耗 $1 的能量！'],
    [/^Travel to another location actually cost (.+)of power$/, '前往另一位置实际消耗 $1 的能量'],
